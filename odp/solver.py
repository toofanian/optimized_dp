...
class HjSolver:
    def __call__(
        ...
        # # Get executable, obstacle check intial value function
        # if self._solve_pde is None:
        #     if grid.dims == 3:
        #         self._solve_pde = graph_3D(dynamics_obj, grid, compMethod["TargetSetMode"], accuracy)
        #     elif grid.dims == 4:
        #         self._solve_pde = graph_4D(dynamics_obj, grid, compMethod["TargetSetMode"], accuracy)
        #     elif grid.dims == 5:
        #         self._solve_pde = graph_5D(dynamics_obj, grid, compMethod["TargetSetMode"], accuracy)
        #     elif grid.dims == 6:
        #         self._solve_pde = graph_6D(dynamics_obj, grid, compMethod["TargetSetMode"], accuracy)
        #     else:
        #         raise ValueError("Dimension not supported")

        if active_set is None:
            active_set = np.ones(grid.pts_each_dim, dtype=int)
        ...
        for i in range(1, len(tau)):
            ...
            while tNow <= tau[i] - 1e-4:
                ...
                if grid.dims == 5:
                    self._solve_pde(V_1, V_0, list_x1, list_x2, list_x3, list_x4, list_x5, t_minh, l0)
                if grid.dims == 6:
                    self._solve_pde(V_1, V_0, list_x1, list_x2, list_x3, list_x4, list_x5, list_x6, t_minh, l0)
...
def hj_solve(
    ...
    # Get executable, obstacle check intial value function
    if grid.dims == 3:
        _solve_pde = graph_3D(dynamics_obj, grid, compMethod["TargetSetMode"], accuracy)
    elif grid.dims == 4:
        _solve_pde = graph_4D(dynamics_obj, grid, compMethod["TargetSetMode"], accuracy)
    elif grid.dims == 5:
        _solve_pde = graph_5D(dynamics_obj, grid, compMethod["TargetSetMode"], accuracy)
    elif grid.dims == 6:
        _solve_pde = graph_6D(dynamics_obj, grid, compMethod["TargetSetMode"], accuracy)
    else:
        raise ValueError("Dimension not supported")
    ...
    for i in range(1, len(tau)):
        ...
        while tNow <= tau[i] - 1e-4:
            ...
            # Run the execution and pass input into graph
            if grid.dims == 3:
                _solve_pde(V_1, V_0, list_x1, list_x2, list_x3, t_minh, l0, active_set)
            elif grid.dims == 4:
                _solve_pde(V_1, V_0, list_x1, list_x2, list_x3, list_x4, t_minh, l0, probe)
            elif grid.dims == 5:
                _solve_pde(V_1, V_0, list_x1, list_x2, list_x3, list_x4, list_x5, t_minh, l0)
            elif grid.dims == 6:
                _solve_pde(V_1, V_0, list_x1, list_x2, list_x3, list_x4, list_x5, list_x6, t_minh, l0)
            else:
                raise ValueError("Dimension not supported")
